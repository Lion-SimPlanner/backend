...
namespace LionSimPlanner.Asset.Infrastructure.Migrations
{
    ...
    [Migration("20260727082011_AddSimulatorDefectsTable")]
    partial class AddSimulatorDefectsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LionSimPlanner.Asset.Domain.Entities.SimulatorDefect", b =>
                {
                    ...
                    b.Property<string>("ResolvedByEngineerCode")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("resolved_by_engineer_code");

                    b.Property<Guid?>("ResolvedByEngineerId")
                        .HasColumnType("uuid")
                        .HasColumnName("resolved_by_engineer_id");
                    ...
                    b.HasKey("DefectId")
                        .HasName("pk_simulator_defects");

                    b.HasIndex("Severity")
                        .HasDatabaseName("idx_defects_severity");

                    b.HasIndex("SimulatorId")
                        .HasDatabaseName("idx_defects_simulator_id");

                    b.HasIndex("Status")
                        .HasDatabaseName("idx_defects_status");

                    b.ToTable("simulator_defects", "maint");
                });
            ...
            modelBuilder.Entity("LionSimPlanner.Asset.Domain.Entities.SimulatorDefect", b =>
                {
                    b.HasOne("LionSimPlanner.Asset.Domain.Entities.Simulator", "Simulator")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_simulator_defects_simulators_simulator_id");
